    ...
    const dinnerMenus = [
        {
            ...
            imageUrl: "https://via.placeholder.com/800x600?text=스테이크"
        },
        {
            name: "파스타 (Pasta)",
            description: "신선한 토마토 소스와 바질로 맛을 낸 이탈리아 파스타.",
            imageUrl: "https://via.placeholder.com/800x600?text=파스타"
        },
        {
            name: "초밥 (Sushi)",
            description: "다양한 신선한 해산물로 만든 일본 전통 초밥 세트.",
            imageUrl: "https://via.placeholder.com/800x600?text=초밥"
        },
        {
            name: "한정식 (Korean Full Course Meal)",
            description: "다채로운 반찬과 메인 요리로 구성된 푸짐한 한국 전통 한정식.",
            imageUrl: "https://via.placeholder.com/800x600?text=한정식"
        },
        {
            name: "타코 (Taco)",
            description: "매콤한 고기와 신선한 채소가 어우러진 멕시칸 타코.",
            imageUrl: "https://via.placeholder.com/800x600?text=타코"
        },
        {
            name: "피자 (Pizza)",
            description: "쭉 늘어나는 치즈와 토핑이 일품인 따끈따끈한 피자.",
            imageUrl: "https://via.placeholder.com/800x600?text=피자"
        },
        {
            name: "샐러드 (Salad)",
            description: "신선한 채소와 닭가슴살, 드레싱이 어우러진 건강한 샐러드.",
            imageUrl: "https://via.placeholder.com/800x600?text=샐러드"
        }
    ];
